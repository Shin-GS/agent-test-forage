...
class RuleBasedIntentResolverTest {
    ...
    void withService_noRecipeMatch_returnsNoMatch() {
        IntentContext context = ctx("존재하지않는작업xyz", 1L,
                List.of(new RecipeCandidate(10L, "회원가입", "회원가입 레시피", List.of("signup"))),
                List.of(), null);
    ...
    void withService_multipleRecipeMatch_returnsShowCandidates() {
        IntentContext context = ctx("주문 관련 작업", 1L,
                List.of(new RecipeCandidate(10L, "주문 생성", "주문 생성", List.of()),
                        new RecipeCandidate(11L, "주문 취소", "주문 취소", List.of())),
                List.of(), null);
    ...
    void withService_tagMatch_returnsExecuteRecipe() {
        ...
        IntentContext context = ctx("signup 진행", 1L,
                List.of(new RecipeCandidate(10L, "계정 생성", "설명", List.of("signup"))),
                List.of(), null);
    ...
    void withService_referenceId_prioritizesThatRecipe() {
        ...
        IntentContext context = ctx("아무말", 1L,
                List.of(new RecipeCandidate(10L, "회원가입", "설명", List.of()),
                        new RecipeCandidate(20L, "로그인", "설명", List.of())),
                List.of(), "recipe_20");
    ...
    void withService_tooShortUtterance_returnsClarify() {
        IntentContext context = ctx("ㅇ", 1L,
                List.of(new RecipeCandidate(10L, "회원가입", "설명", List.of())),
                List.of(), null);
